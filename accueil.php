...
<body>
         ...
         <div class="leftcolumn">
            <div class="card3">
               ...
               <form action="" method="POST">
                  <textarea id="textareaChars" maxlength="350" required name="title" maxlength="300" placeholder="Type or paste your question here..."></textarea>
                  <script>
                     var maxLength = 300;
                  ...
                  <span id="chars" style="font-size: 12px;">350 characters only</span>
            ...
            <div class="card2">
               ...
               $co = connexionBdd();
               $query = $co->query("SELECT * FROM questions LIMIT 0,31"); //Added limiter to fatch only 30 rows
               $results = $query->fetchAll();
            ...
            <p class="loading" data-text="loading...">Loading...</p>
         </div>
   ...
   <!--<section>
      <div class="container">
        <h3>Welcome <?php echo $_SESSION["pseudo"]; ?> </h3>
         <?php /*
